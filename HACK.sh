...
clear
echo -e "$g╔══════════════════════════════════════╗    " | pv -qL 600
echo -e "$g║  ${y}HACKED BY RENXPLOIT      $g║"| pv -qL 600
echo -e "$g╚══════════════════════════════════════╝"| pv -qL 600
echo -e "$g╔══════════════════════════════════════════════╗"| pv -qL 600
echo -e "$y Code By : RENXPLOIT                                              " | pv -qL 600
echo -e "$y Github  : https://github.com/kontol-laba"| pv -qL 600
echo -e "$y TIKTOK:renxploit1"                  | pv -qL 600
echo -e "$g╚══════════════════════════════════════════════╝"| pv -qL 600
}
mulai (){
...
sleep 2
echo -e "${g}Selesai${o}"
echo -e "$g╔═╣${y}  Mau lagi gak syng ? ${g}║"
echo -e "$g║ ╚══════════════════╝"
...
menu(){
echo -e "$g╔════════════════════════╗"| pv -qL 600
echo -e "$g║$y  Pilih menunya lah anj  $g║"| pv -qL 600
echo -e "$g╚════════════════════════╝"| pv -qL 600
echo -e "${p}"
...
banner
echo -e "$g╔════════════════════════╗    "
echo -e "$g║    ${y}Script di kunci renxploit    $g║"
echo -e "$g╚════════════════════════╝"
echo -e "passwordnya : root"
echo -e "$g  ╔══════════════════════════╗"
echo -e "$g╔═╣  ${y}MASUKAN PASSWORDNYA ANJ ${g} ║"
echo -e "$g║ ╚══════════════════════════╝"
